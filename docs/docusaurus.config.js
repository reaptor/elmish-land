...
const config = {
    ...
    organizationName: 'reaptor', // Usually your GitHub org/user name.
    projectName: 'elmish-land', // Usually your repo name.
    ...
    themeConfig:
        ...
        ({
            metadata: [
                { name: 'keywords', content: 'fsharp, f#, fable, elmish, dotnet' }
            ],
            image: 'img/logo.svg',
            colorMode: {
                defaultMode: 'dark',
