---
slug: using-tailwind-css-with-fable-and-elmish
title: Using Tailwind CSS with Fable and Elmish Land
authors: [klofberg]
---
...
### 4. Add you CSS file to index.html

Add a link to your `styles.css` in the `<head>` section of your `index.html`, then start using Tailwind’s utility classes to style your content.
