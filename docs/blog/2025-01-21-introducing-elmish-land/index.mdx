...
Elmish Land brings [type safety to route and query parameters](/docs/core-concepts/pages#type-safe-routing) through a `route.json` file. This approach guarantees that all parameters are correctly 
