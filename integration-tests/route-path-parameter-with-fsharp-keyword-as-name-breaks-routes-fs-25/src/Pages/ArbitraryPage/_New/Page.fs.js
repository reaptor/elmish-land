...
export function Msg_$reflection() {
    return union_type("route-path-parameter-with-fsharp-keyword-as-name-breaks-routes-fs-25.Pages.ArbitraryPage.New.Page.Msg", [], Msg, () => [[["Item", Msg_$reflection_1()]]]);
}
