...
let ``detectLayoutMismatch works with any page and layout combination`` () =
    task {
        ...
        let productError =
            "./src/Pages/Products/Page.fs(10,20): (10,30) error FSHARP: The type 'Layout.Msg' does not match the type 'Products.Layout.Msg' (code 1)"
        ...
        let userError =
            "./src/Pages/Users/Settings/Page.fs(15,10): (15,20) error FSHARP: The type 'Layout.Msg' does not match the type 'Users.Settings.Layout.Msg' (code 1)"
        ...
        let adminError =
            "./src/Pages/Admin/Dashboard/Page.fs(20,5): (20,15) error FSHARP: The type 'Pages.Layout.Msg' does not match the type 'Admin.Dashboard.Layout.Msg' (code 1)"
        ...
        let appError =
            "./.elmish-land/App/App.fs(250,20): (250,30) error FSHARP: The type 'Layout.Msg' does not match the type 'Store.Products.Layout.Msg' (code 1)"
        ...
        let deepError =
            "./src/Pages/Admin/Users/Settings/Page.fs(30,10): (30,20) error FSHARP: The type 'Layout.Msg' does not match the type 'Admin.Users.Settings.Layout.Msg' (code 1)"
